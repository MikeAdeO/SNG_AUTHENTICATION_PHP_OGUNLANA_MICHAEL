		...
		<div class="container-fluid">
			<div class="row">
				<?php if($arrContent->accntType  == 2) { ?>
					<div class="col-3">
						<div style="margin-bottom: 20px; text-align:center; background:#fff; border: 1px solid #ccc; padding: 0px 10px; border-radius: 3px;box-shadow:0px 1px 0px 1px silver">
				...
				<div class="col-3">
					<div style="margin-bottom: 20px; text-align:center; background:#fff; border: 1px solid #ccc; padding: 0px 10px; border-radius: 3px;box-shadow:0px 1px 0px 1px silver">
						<a href="patientlist.php" style="color: #EB5424; text-decoration: none" title="Manage User">
							<div style=" padding:10px; font-size:28px">
				...
				<div class="col-3">
					<div style="margin-bottom: 20px; text-align:center; background:#fff; border: 1px solid #ccc; padding: 0px 10px; border-radius: 3px;box-shadow:0px 1px 0px 1px silver">
						<a href="medicalteamlist.php" style="color: #EB5424; text-decoration: none" title="Manage User">
							<div style=" padding:10px; font-size:28px">
								<i class="fa fa-users fa-3x"></i>
								<br>
									Manage Doctors
